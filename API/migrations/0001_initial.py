# Generated by Django 3.2.19 on 2023-07-07 14:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[API.Validators.validate_lowercase])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adress', models.CharField(blank=True, default='-', max_length=500)),
                ('manager', models.ForeignKey(limit_choices_to={'type': 'Trader'}, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('by', models.ForeignKey(limit_choices_to={'type': 'Customer'}, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
